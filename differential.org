...
Now we need to develop the rest of the question
1. find all points x such that f'(x) = 0
2. determine those intervals in which f is monotonic
3. determine those intervals in which f' is monotonic
